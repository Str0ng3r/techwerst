        ...
        <div className={styles.sidebar}>
          <div className={styles.sidebar_logo}>
            <svg
              ...
              viewBox="0 0 37 37"
              fill="none"
              className={styles.menucont_icons}
            >
              <path
            ...
            <h2 className={styles.logo_name}>Dashboard</h2>
            <p className={styles.logo_version}>v.01</p>
          </div>
          <div className={styles.menucont}>
            <ul className={styles.menucont_list}>
              <li className={styles.menucont_li}>
                <div className={styles.menucont_li_wrapper}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                ...
                <svg
                  ...
                  viewBox="0 0 16 16"
                  fill="none"
                  className={styles.menucont_buttons}
                >
                  <path
                    d="M6 12L10 8L6 4"
                    stroke="#9197B3"
          ...
          <div className={styles.sidebar_profile}>
            ...
            <div className={styles.profile_wrap_name}>
              <p className={styles.profile_name}>Evano</p>
              <p className={styles.profile_work}>Project Manager</p>
            </div>
          </div>
        </div>
        <div className={styles.mainsect}>
          <h1 className={styles.mainsect_hello}>Hello Evano 👋🏼,</h1>
          <div className={styles.mainsect_table}>
            <div className={styles.mainsect_searchline}>
              <div className={styles.searchline_wrap}>
                <h3 className={styles.mainsect_costumers}>All Costumers</h3>
                <h4 className={styles.mainsect_members}>Active Members</h4>
              </div>
              <label htmlFor="search" className={styles.mainsect_label}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                ...
                <input
                  ...
                  id="search"
                  placeholder="Search"
                  className={styles.mainsect_input}
                />
              </label>
            </div>
